...
/**
 * BTreeNode Class - suppose to hold all the methods for a BTree Created with
 * help from the professor CS321 - Final Projet
 *
 * May 7Th 2021
 * 
 * @Olivia Coca
...
public class BTreeNode {
	...
	BTreeNode getBTreeNode(long idx) {
		...
		/*
		 * LinkedList<BTreeNode> BTreeNodeList = cache.returnAllitems(); for (BTreeNode
		 * n : BTreeNodeList){ if(n.fileIndex == idx){ newBTreeNode = n; return
		 * newBTreeNode; } }
		 */
		return newBTreeNode;
	}
